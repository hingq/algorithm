...
<template>
    <div class="algorithm-layout">
        <button class="nav-btn open-btn rounded-md border border-slate-300 bg-white p-2 text-slate-700 shadow-sm dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100" aria-label="打开导航">
            <el-icon><Menu /></el-icon>
        </button>
        <div class="nav nav-black">
            <div class="nav nav-red">
                <div class="nav nav-white dark:bg-slate-900 dark:text-slate-100">
                    <button class="nav-btn close-btn rounded-md border border-slate-300 bg-white p-1 text-slate-500 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-300" aria-label="关闭导航">
